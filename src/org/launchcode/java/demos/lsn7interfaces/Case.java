...
public class Case {
 ...
 private ArrayList<Topping> toppings = new ArrayList<>();
    public Case() {
        ...
        Topping topping1 = new Topping("Whipping Cream", 0.15, new ArrayList<>(Arrays.asList("diary", "nuts")));
        Topping topping2 = new Topping("Chocolate", 0.75, new ArrayList<>(Arrays.asList("Peanuts")));
        Topping topping3 = new Topping("M&Ms", 0.50, new ArrayList<>(Arrays.asList("diary")));
